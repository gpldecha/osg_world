...
int main()
{
   ...
   root = new osg::Group();
   tankNode = osgDB::readNodeFile("/home/guillaume/cpp_workspace/test_open_scene_graph/NPS_DataModels/t72-tank/t72-tank_des.flt");
   ...
   HUDTexture->setImage(osgDB::readImageFile("/home/guillaume/cpp_workspace/test_open_scene_graph/NPS_Data/Textures/sky.bmp"));
